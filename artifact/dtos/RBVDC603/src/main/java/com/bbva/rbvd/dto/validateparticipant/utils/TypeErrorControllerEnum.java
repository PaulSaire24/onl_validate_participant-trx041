...
public enum TypeErrorControllerEnum {
    ...
    ERROR_PBTQ_INCOMPLETE_CLIENT_INFORMATION("La información del cliente no pudo ser obtenida debido a un error en el servicio de personas. Por favor, inténtelo de nuevo más tarde."),
