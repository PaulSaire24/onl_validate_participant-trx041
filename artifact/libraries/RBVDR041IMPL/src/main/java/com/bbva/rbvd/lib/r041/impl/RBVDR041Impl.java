...
public class RBVDR041Impl extends RBVDR041Abstract {
	...
	@Override
	public AgregarTerceroBO executeValidateAddParticipant(ValidateParticipantDTO input) { //falta el trycatch
		...
		try{
			...
			ValidationParameter validationParameter = new ValidationParameter(pisdR601, pbtqR002, pisdR012, ksmkR002, rbvdR066, participantProperties);
			...
			InsuranceProduct insuranceProduct = ProductFactory.buildProduct(quotationInformation.getInsuranceProduct().getInsuranceProductType(),pisdR352,pbtqR002,validationParameter);
