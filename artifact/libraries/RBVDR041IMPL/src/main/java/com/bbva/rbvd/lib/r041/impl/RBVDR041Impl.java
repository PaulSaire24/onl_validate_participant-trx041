...
public class RBVDR041Impl extends RBVDR041Abstract {
	...
	public AgregarTerceroBO executeValidateAddParticipant(InputParticipantsDTO input) {
        ...
        ParticipantValidations validate = FactoryProductValidate.getProductType(quotationInformation.getInsuranceProduct().getInsuranceProductType(),rbvdR048,pbtqR002);
